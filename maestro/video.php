    ...
    <main class="maestro gestionar">
        <div class="principal">
                ...
                <table>
                    ...
                    <?php while( $material = mysqli_fetch_assoc($resultado) ): ?>
                        <tr>
                            ...
                            <td style="text-align: center; cursor: pointer;"><a href="/maestro/eliminarVideo.php?id=<?php echo $material['idMaterial'];?>">❌</a></td>
                        </tr>
                    <?php endwhile; ?>
                </table>
            </div>
            ...
            <div class="modal <?php if(!$id) echo 'none'; ?>" id="modal">
                <div class="contenido">
                    <h2>Editar Video</h2>
                    <form  method="POST" action="editarVideo.php?id=<?php echo $id; ?>">
                        <?php 
